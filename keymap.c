...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_all(
      ...
      KC_LSFT,   _______, KC_Z,    KC_X,    KC_C,      KC_V,    KC_B,   KC_N,   KC_M,      KC_COMM, KC_DOT,  KC_RSFT,  KC_SLSH,      LCA(KC_UP),  KC_SLSH,       \
...
void set_underglow(void) {
    ...
    case L_HMSP:
        ...
        sethsv(HSV_PURPLE, (LED_TYPE *)&led[14]);
        sethsv(HSV_PURPLE, (LED_TYPE *)&led[15]);
        rgblight_set();
        break;
    default:
    //rgblight_sethsv_noeeprom_white();
